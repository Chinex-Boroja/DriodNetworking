...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeData> extractEarthquakes() {
        ...
        try {
            ...
            //Create a JSON Object from the SAMPLE_JSON_RESPONSE string and store im jsonRootObject
            JSONObject jsonRootObject = new JSONObject(SAMPLE_JSON_RESPONSE);

            //Get the instance of JSONArray that contains JSONObjects and extract the key
            //called "features" which represents a list of features (or earthquakes)
            ...
            for(int i = 0; i < jsonArray.length(); i++) {
                ...
                //extract the JSON objects to properties key
...
//                String time1 = Long.toString(time);
                ...
                //Create a new earthquake object from these three strings
                EarthquakeData earthquakeData = new EarthquakeData(magnitude, location, time, url);
                //add the object to the list of earthquake
